        ...
        foreach sort (my_firstD_neigh)  ;revisit
          [x ->
            if [alternatives1_i]  of x = product_key [
              ifelse [total-encounter-hec] of x > 0
...
"" ""
PENS
"general" 1.0 0 -16777216 true "" "plot mean [effectivity-mit_1] of farmers with [total-encounter-hec > 0]"
"e-fence" 1.0 0 -11221820 true "" "plot mean [effectivity-mit_1] of farmers with [total-encounter-hec > 0 and alternatives1_i = 1]"
"spotlight" 1.0 0 -2674135 true "" "plot mean [effectivity-mit_1] of farmers with [total-encounter-hec > 0 and alternatives1_i = 2]"
"carbide" 1.0 0 -8330359 true "" "plot mean [effectivity-mit_1] of farmers with [total-encounter-hec > 0 and alternatives1_i = 3]"
