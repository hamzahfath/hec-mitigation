...
<experiments>
  ...
  <experiment name="attack variation v5" repetitions="5" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="40"/>
    <metric>mean [threat-appraisals] of farmers</metric>
  ...
  <experiment name="communication variation v5b" repetitions="5" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="40"/>
    <metric>mean [threat-appraisals] of farmers</metric>
