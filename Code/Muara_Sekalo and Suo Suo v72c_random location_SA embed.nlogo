...
to record-bayesian-epidemical-evidence
  if ticks > 1 [
    ask farmers[set t-epidemical-evidence manual-bn-using-pm2 EE-from-neighbor]
  ]
end
...
to-report manual-bn [EE-tables]
  ...
  report py:runresult "conditional_probability(att_l,dmg_l)"
end
...
to-report manual-bn-using-pm [EE-tables]
    py:set "att_l" table:get EE-tables "attacks"
    py:set "dmg_l" table:get EE-tables "damaged?"
  ...
  (py:run
   ...
   "def calculate_inference(attacks_l, damage_l, using_pm_l=None):"
    ...
    "     else:"
    "          result = np.sum((damage_array == 1) & (attacks_array == 1)) / np.sum(attacks_array == 1)"
    "     return result"
)
...
"pen-3" 1.0 0 -955883 true "" "plot standard-deviation [t-epidemical-evidence] of farmers"
...
<experiments>
  ...
  <experiment name="capital variation v6" repetitions="5" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="80"/>
    <metric>mean [threat-appraisals] of farmers</metric>
  ...
  <experiment name="parameter config v2" repetitions="5" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="30"/>
    <metric>final_rmse_score</metric>
